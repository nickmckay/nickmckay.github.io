...
library(knitr)
library(kableExtra)
# library(readr)  # Using base R read.csv instead
...
This page automatically updates with publications from [Google Scholar](https://scholar.google.com/citations?user=j8_CgoEAAAAJ&hl=en) using the R `scholar` package. The database is automatically refreshed each time the page builds.
...
# Load data from local database (updated periodically via R/update_publications.R)
# Try multiple potential paths for the CSV files
data_paths <- c(
  "R/data/publications.csv",
  "../../R/data/publications.csv", 
  "../../../R/data/publications.csv"
)

citation_paths <- c(
  "R/data/citation_history.csv",
  "../../R/data/citation_history.csv", 
  "../../../R/data/citation_history.csv"
)

profile_paths <- c(
  "R/data/profile_metrics.csv",
  "../../R/data/profile_metrics.csv", 
  "../../../R/data/profile_metrics.csv"
)
...
tryCatch({
  ...
  if (!is.null(pub_file) && !is.null(cit_file) && !is.null(prof_file)) {
